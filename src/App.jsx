...
export default function App() {
  ...
  const [complianceData, setComplianceData] = useState({
    ...
    'Golden Coast': [
      { building: 'The Win Post Acute',      status: 'Green',  actionItem: 'Focus on functional levels in daily notes.' },
      ...
      { building: 'Gilroy HC',               status: 'Yellow', actionItem: 'Resolve careplans upon payor change to LTC.' },
      ...
      { building: 'Mountain View HC',        status: 'Yellow', actionItem: 'DC/resolve orders and careplans for payor change. Clarification orders not in compliance. OT standardized tests.' },
      ...
      { building: 'Los Altos Post Acute',    status: 'Yellow', actionItem: 'RNA program needs orders — audit RNA careplans. Standardized tests missing in evals.' },
