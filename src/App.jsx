...
export default function App() {
  ...
  const [complianceData, setComplianceData] = useState({
    'Overland': [
      { building: 'Belmont Healthcare Center',      status: 'Green',  actionItem: 'Work on DC orders and resolving careplans. Address copy/paste documentation.' },
      { building: 'Capital Post Acute',             status: 'Green',  actionItem: 'OT standardized tests in NetHealth. Clarification order template — OT missing.' },
      ...
      { building: 'Eden Healthcare Center',         status: 'Yellow', actionItem: 'JMA ongoing. Standardized tests missing on evals (OT/ST). Use clarification order template in PCC.' },
      { building: 'West Shore Post Acute',          status: 'Yellow', actionItem: 'Bring JMA to 60% complete.' },
      { building: 'Bridgewood Post Acute',          status: 'Yellow', actionItem: 'JMA ongoing. Add PT standardized tests to evals.' },
      { building: 'Cedarwood Post Acute',           status: 'Yellow', actionItem: 'JMA ongoing. Add standardized tests across all disciplines.' },
      { building: 'Golden Harbor Healthcare Center',status: 'Yellow', actionItem: 'Standardized tests for PT/OT/SLP. Eval orders need DC. Reclarification orders expired for PT.' },
    ...
    'Golden Coast': [
      ...
      { building: 'Pacific Hills Post Acute',       status: 'Green',  actionItem: 'Inservice therapists on mandatory levels for PT/OT.' },
      { building: 'Pacific Coast Manor',            status: 'Green',  actionItem: 'Continue to work on DC eval orders.' },
      { building: 'Gilroy Healthcare Center',       status: 'Yellow', actionItem: 'Resolve careplans upon payor change to LTC. Complete JMA.' },
      ...
      { building: 'Mountain View',                  status: 'Yellow', actionItem: 'DC/resolve orders for payor change. Clarification orders not in compliance. OT standardized tests.' },
      { building: 'Morgan Hill Healthcare Center',  status: 'Yellow', actionItem: 'SLP careplans missing. DC eval orders. Check therapy diagnosis before triple check.' },
      ...
      { building: 'Manresa Healthcare Center',      status: 'Red',    actionItem: 'All compliance areas require immediate attention. New DOR to establish all processes — top Q2 priority.' },
    ],
  });
  const [alosData, setAlosData] = useState({
    // Golden Coast
    'Camino Ridge Post Acute':  { jan: '41.6', feb: '39.3', mar: '34.1', apr: '42.8' },
    'Gilroy Healthcare Center': { jan: '53.8', feb: '46.0', mar: '32.2', apr: '43.2' },
    'Los Altos Post Acute':     { jan: '33.9', feb: '34.4', mar: '28.0', apr: '39.1' },
    'Manresa Healthcare Center':{ jan: '48.5', feb: '46.8', mar: '49.4', apr: '46.4' },
    'Morgan Hill Healthcare Center': { jan: '33.2', feb: '36.0', mar: '52.2', apr: '18.5' },
    'Mountain View':            { jan: '35.6', feb: '27.4', mar: '33.9', apr: '37.7' },
    'Pacific Coast Manor':      { jan: '32.4', feb: '35.3', mar: '34.9', apr: '28.6' },
    'Pacific Hills Post Acute': { jan: '34.6', feb: '31.6', mar: '45.9', apr: '43.7' },
    'The Win Post Acute':       { jan: '37.2', feb: '40.7', mar: '37.0', apr: '62.4' },
    'Palo Alto Post Acute':     { jan: '',     feb: '',     mar: '',     apr: '31.9' },
    // Overland
    'Belmont Healthcare Center':{ jan: '33.4', feb: '39.2', mar: '39.8', apr: '45.75' },
    'Blue Oak Post Acute':      { jan: '20.0', feb: '18.2', mar: '24.2', apr: '18.0' },
    'Bridgewood Post Acute':    { jan: '20.7', feb: '51.4', mar: '64.3', apr: '72.75' },
    'Capital Post Acute':       { jan: '8.6',  feb: '31.7', mar: '34.8', apr: '62.5' },
    'Cedarwood Post Acute':     { jan: '30.5', feb: '36.6', mar: '33.5', apr: '19.86' },
    'Eden Healthcare Center':   { jan: '33.8', feb: '41.3', mar: '38.2', apr: '20.67' },
    'Golden Harbor Healthcare Center': { jan: '26.8', feb: '45.6', mar: '45.4', apr: '55.0' },
    'West Shore Post Acute':    { jan: '47.6', feb: '21.8', mar: '38.6', apr: '56.05' },
  });
