...
export default function App() {
  ...
  const [complianceData, setComplianceData] = useState({
    ...
    'Golden Coast': [
      ...
      { building: 'Gilroy HC',               status: 'Yellow', actionItem: 'Resolving careplans upon payor change to LTC.' },
      ...
      { building: 'Los Altos Post Acute',    status: 'Yellow', actionItem: 'RNA program needs orders. Standardized tests in evals for PT.' },
      { building: 'Manresa HC',              status: 'Red',    actionItem: 'With new DOR, all processes need to be put in place.' },
    ],
  });
